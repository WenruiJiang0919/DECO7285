<template>
    <div class="container" style="width: 60%;">
        <h1 class="my-4" style="color: #cc7d25;text-align: center;">Update Recipe</h1>
        ...
        <button class="btn btn-primary mt-4" @click="uploadRecipe">Update Recipe</button>
    </div>
</template>
...
// import {  } from '../api/meal'
import { getShowRecipeApi, editRecipeApi } from '../api/meal'
...
export default {
    ...
    created() {
        getShowRecipeApi(this.username, this.recipe_id).then(response => {
            ...
            this.imagePreview = this.recipe.imgPath
        }).catch(error => {
            ...
            if (this.changeFile) {
                ...
                axios.post('/uploadImg', formData, {
                    ...
                    let newrecipe = {
                        ...
                        LengthOfTime: this.recipe.LengthOfTime,
                        Description: this.recipe.Description,
                        Cuisine: this.recipe.Cuisine,
                        Steps: this.recipe.Steps
                    }
                    editRecipeApi(newrecipe, this.recipe_id).then(response => {
                ...
                console.log(this.recipe.imgPath)
                this.recipe.imgPath = this.recipe.imgPath.split('=')[1]
                console.log(this.recipe.imgPath)
                let newrecipe = {
                    username: localStorage.getItem('username'),
                    recipeName: this.recipe.recipeName,

...
<script>
import { likeRecipeApi, unlikeRecipeApi, favoriteRecipeApi, unfavoriteRecipeApi,userlikeRecipeApi } from '../api/meal'
...
export default {
    ...
    methods: {
        ...
        fetchRecipes() {
            ...
            userlikeRecipeApi(this.username).then(response => {

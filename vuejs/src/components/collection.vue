...
<script>
import { likeRecipeApi, unlikeRecipeApi, favoriteRecipeApi, unfavoriteRecipeApi,userfavoriteRecipeApi } from '../api/meal'
...
export default {
    ...
    methods: {
        ...
        fetchRecipes() {
            ...
            userfavoriteRecipeApi(this.username).then(response => {

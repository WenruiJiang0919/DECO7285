    ...
    <div class="container">
        <div>
            <vs-alert color="warn" v-if="recipes.length===0">
                ...
                There is no Post. Click New Meal to Upload!
                </vs-alert>
            <div v-for="recipe in recipes" :key="recipe.id">
                <div class="recipe-item row">
                    ...
                    <div class="recipe-details col-md-9">
                        ...
                        <button class="btn btn-primary" @click="showRecipeDetail(recipe.recipe_id)">Edit Recipe</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        fetchRecipes() {
            ...
            getAdminRecipe(this.username).then(response => {
        ...
        showRecipeDetail(recipeId) {
            ...
            this.$router.push({ path: "/editRecipe" });
        },
    },
};
</script>
